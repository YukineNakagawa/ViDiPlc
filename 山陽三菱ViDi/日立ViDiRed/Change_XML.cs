...
namespace Example.Runtime
{
    class Change_XML
    {
        ...
        //DELETE_START :2022/1/9 kitayama 理由：設定ファイル名はmainwindowで設定しているので削除
        //string fileName = @"memberse3.xml";
        //DELETE_END :2022/1/9 kitayama 理由：設定ファイル名はmainwindowで設定しているので削除
        ...
        public void WriteXML()
        {
            ...
            //ADD_START :2022/2/5 kitayama 理由：ワンショット時の保存先を追加
            obj.OKImagePath2 = MainWindow.sImagePath[3];
            obj.INTERImagePath2 = MainWindow.sImagePath[4];
            obj.NGImagePath2 = MainWindow.sImagePath[5];
            //ADD_END :2022/2/5 kitayama 理由：ワンショット時の保存先を追加
            //obj.GetImagePath = MainWindow.sGetImagePath;                             //ファイル取得先フォルダ
            //obj.SetImagePath = MainWindow.sSetImagePath;                             //保存先フォルダ
            //CHANGE_START :2021/11/27 kitayama 理由：保存先を配列に変更
            //撮影処理周期を設定する
            obj.GetImageInterval = MainWindow.interval2;
            ...
            //CHANGE_START :2022/1/9 kitayama 理由：ファイル名はmainwindowで設定した変数を読むように変更
            System.IO.StreamWriter sw = new System.IO.StreamWriter(MainWindow.fileName, false, new System.Text.UTF8Encoding(false));
            //System.IO.StreamWriter sw = new System.IO.StreamWriter(fileName, false, new System.Text.UTF8Encoding(false));
            //CHANGE_END :2022/1/9 kitayama 理由：ファイル名はmainwindowで設定した変数を読むように変更
            //シリアル化し、XMLファイルに保存する
        ...
        public void ReadXML()
        {
            ...
            try
            {
                ...
                //読み込むファイルを開く
                //CHANGE_START :2022/1/9 kitayama 理由：ファイル名はmainwindowで設定した変数を読むように変更
                System.IO.StreamReader sr = new System.IO.StreamReader(MainWindow.fileName, new System.Text.UTF8Encoding(false));
                ...
                MainWindow.interval2 = obj.GetImageInterval;
                ...
                //ADD_START :2022/2/5 kitayama 理由：ワンショット時の保存先を追加
                MainWindow.sImagePath[3] = obj.OKImagePath;
                MainWindow.sImagePath[4] = obj.INTERImagePath;
                MainWindow.sImagePath[5] = obj.NGImagePath;
                //ADD_END :2022/2/5 kitayama 理由：ワンショット時の保存先を追加
    ...
    public class SampleClass
    {
        ...
        ///                     画画像取得設定関連パラメタ
        /////////////////////////////////////////////////////////////////////////////
        public int GetImageInterval;        //画画像取得周期（単位msec)　Mainのinterval2の数値を格納する
        ...
        //ADD_START :2022/2/5 kitayama 理由：ワンショット時の保存先を追加
        public string OKImagePath2;
        public string INTERImagePath2;
        public string NGImagePath2;
        //ADD_END :2022/2/5 kitayama 理由：ワンショット時の保存先を追加
